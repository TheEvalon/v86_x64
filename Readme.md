...
- Linux works pretty well. 64-bit kernels boot a generated static initrd
  until userspace `/init` prints `linux64-init: userspace` (`make linux64-test`);
  `make longmode-test` covers CPU entry.
