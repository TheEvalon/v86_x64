...
const ALL_TESTS = ["enter64", "stack64", "idt64", "syscall64", "higher64", "jit64", "rex64", "pf64", "cpl64", "nx64", "cx16", "retf64", "rdtscp", "rcl64", "fxsave64", "xmm8", "popcnt64", "rdrand64"];
...
emulator.add_listener("emulator-loaded", function() {
    ...
    emulator.cpu_exception_hook = function(n) {
        // DEBUG trigger_gp skips IDT delivery when this returns true. cx16 and
