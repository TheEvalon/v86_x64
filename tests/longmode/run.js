...
const ALL_TESTS = ["enter64", "stack64", "idt64", "syscall64", "higher64", "jit64", "jithigh64", "rex64", "pf64", "cpl64", "nx64", "cx16", "retf64", "rdtscp", "rcl64", "fxsave64", "xmm8", "popcnt64", "rdrand64", "ud64", "frame64", "fsbase64", "sreg64", "movq64", "rexw8", "lapic64", "msr64", "movnti64", "clflush64", "asize64", "prefetchw64", "string67"];
...
const emulator = new V86({
    ...
    sync_jit: name === "jit64" || name === "jithigh64",
    apic: name === "lapic64",
    log_level: 0,
});
...
emulator.add_listener("emulator-loaded", function() {
    ...
    cpu.io.register_write_consecutive(0xF4, {},
        function(value) {
            if(value === 0) {
                if((name === "jit64" || name === "jithigh64") && !+process.env.DISABLE_JIT && compiled === 0)
                {
                    finish(1, "long mode " + name + ": JIT did not compile before exit");
                    return;
                }
